...
int GetNumberIndex(int Arr[100],int ArrLength, int Number)
{
	for (int i = 0; i < ArrLength; i++)
	{
		if (Arr[i] == Number)
...
int main()
{
	...
	short NumberIndex = GetNumberIndex(Arr, ArrLength, NumbertoSearch);
	...
	else
	{
		...
		cout << "\nThe number found's order: " << NumberIndex + 1;
	}
